...
const BATCH_SIZE = 25;
/** Brevo transactional welcome template. Override with BREVO_WELCOME_TEMPLATE_ID secret. */
const BREVO_WELCOME_TEMPLATE_ID_DEFAULT = 2;
/** Brevo paywall contacts list. Override with BREVO_PAYWALL_LIST_ID secret. */
