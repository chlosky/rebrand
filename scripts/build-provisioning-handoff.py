#!/usr/bin/env python3
"""Generate post-paywall provisioning handoff (full flow + UI, code only)."""
...
OUT = ROOT / "chatgpt-post-paywall-provisioning-handoff.md"
FENCE = "```"
...
EXPLICIT = [
    ...
    # Setup draft → provisioning inputs
    ...
    # Shared UI used by paywall / setup / loading screens
    ...
    "src/lib/utils.ts",
    "src/debugLog.ts",
    # Hooks + auth used by setup / paywall
