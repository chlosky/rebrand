...
function MobileLandingMimiPage() {
  const { t } = useMarketingTranslation();
  ...
  useEffect(() => {
    ...
    trackMarketingConversion("landing_view", {
      page_path: pagePath,
      content_id: pagePath,
      content_name: "mobile_landing_mimi",
        ...
        >
          ...
          <div className="mt-6 w-full max-w-[min(100%,23rem)] self-start">
            <MarketingStoreBadges
              ...
              onStoreClick={(store) => cta.onStoreClick("mobile_landing_mimi_store", store)}
            />
          </div>
...
export default function MobileLandingMimi() {
  return (
    <MarketingStoreCtaProvider>
      <MobileLandingMimiPage />
    </MarketingStoreCtaProvider>
  );
}
